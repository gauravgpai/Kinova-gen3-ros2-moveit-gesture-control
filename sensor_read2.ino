...
//const char networkName = "shubham";
//const charnetworkPswd = "shubham1234";
const char *networkName = "ErenHatDasWLANnachKoelnGenommen";
const char *networkPswd = "CurrykingAutoDennis";

//IP address to send UDP data to:
// either use the ip address of the server or
// a network broadcast address
const char *udpAddress = "192.168.178.176";
